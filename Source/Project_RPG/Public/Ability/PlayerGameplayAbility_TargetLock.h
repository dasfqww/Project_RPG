 ...
 */
UCLASS()
class PROJECT_RPG_API UPlayerGameplayAbility_TargetLock : public URPGPlayerGameplayAbility
{
	GENERATED_BODY()
public:
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Target Lock")
		TSubclassOf<URPGWidgetBase> TargetLockWidgetClass;
	...
	UPROPERTY()
		TObjectPtr<URPGWidgetBase> DrawnTargetLockWidget;
